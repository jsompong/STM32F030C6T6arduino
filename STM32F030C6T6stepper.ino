...
void setup() {
Serial1.begin(2400);      // initialize the serial port:
...
pinMode(PC13, OUTPUT);
Serial1.println("..........................");
Serial1.print("Baud Rate 2400 : ");
Serial1.println("STM32F030C6T6 with Arduino");
Serial1.println("21 October 2024");
Serial1.println("STM32F030C6T6stepper.inO");
Serial1.println("..........................");
...
void loop() {
  ...
  Serial1.print("steps:");  Serial1.println(stepCount);
  stepCount++;  delay(50);
   for (int i=0; i<30; i++) {
 Serial1.print(Digit5th, DEC);
 Serial1.print(Digit4th, DEC);
 Serial1.print(Digit3rd, DEC);
 Serial1.print(Digit2nd, DEC);
 Serial1.println(tempC, DEC);
